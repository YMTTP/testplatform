...
public class MonitorServiceImpl implements MonitorService{
	...
	public MonitorTask findMonitorTaskById(int id){
		return MonitorTaskDao.get("from MonitorTask where id = ? and del=0", new Object[] { id });
	}
	...
	public MonitorRelation findMonitorRelationById(int id) {
		return MonitorRelationDao.get("from MonitorRelation where id = ?", new Object[] { id });
	}

		@Override
		public List<MonitorRelation> findMonitorRelationByStressItemId(int itemid){
			return MonitorRelationDao.find("from MonitorRelation where monitorItemId = ? ", new Object[] { itemid });
		}
	...
	public MonitorConfig findMonitorConfigById(int id) {
		return MonitorConfigDao.get("from MonitorConfig where id = ?", new Object[] { id });
	}

	@Override
	public void deleteMonitorConfig(
			MonitorConfig MonitorConfig) {
		MonitorConfigDao.delete(MonitorConfig);
	}

	@Override
	public List<MonitorConfig> findMonitorConfigsByTaskId(
			Integer taskid) {
		return MonitorConfigDao.find("from MonitorConfig where taskid = ?", new Object[] { taskid });
	}
	...
	public MonitorItem findMonitorItemById(int id) {
		return MonitorItemDao.get("from MonitorItem where id = ? order by startTime asc", new Object[] { id });
	}
	...
	@Override
	public List<MonitorItem> findMonitorItemsByTaskId(
			Integer taskId) {
		return MonitorItemDao.find("from MonitorItem where taskId = ?", new Object[] { taskId });
	}
	
	@Override         
	public List<MonitorItem> findMonitoredItemsByTaskId(
			Integer taskId) {
		return MonitorItemDao.find("from MonitorItem where taskId = ?  and endTime>now()", new Object[] { taskId });
	}
	...
	public MonitorInfo findMonitorInfoById(int id) {
		return MonitorInfoDao.get("from MonitorInfo where id = ?", new Object[] { id });
	}
	...
	public List<MonitorInfo> findMonitorInfosByConfigIdAndItemId(
		...
		return MonitorInfoDao.find("from MonitorInfo where configId = ?  and itemId = ?", new Object[] { configId, itemId });
	}
