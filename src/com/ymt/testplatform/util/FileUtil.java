...
public class FileUtil {
    ...
    public boolean extTarFileList(String directory,String filename) {  
        ...
        try {  
            ...
            flag = false;  
             ...
             logger.info("extTarFileList Exception: "+  ioe.getLocalizedMessage() );
        }  
        return flag;  
    }  
     ...
     * FTP下载单个文件测试 
     */  
    public void fileDownloadByFtp(String ip,String username,String password,String remotePath, String fileName ,String localPath) {  
    ...
    public static void main(String[] args) {
		...
		fileUtil.fileDownloadByFtp("172.16.103.126","ftpuser","1qaz@WSX","/STRESS/","test.sh","f:/tools");
